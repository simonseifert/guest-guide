...
order: 6
category: tech
summary: Impostare l'orologio, programmi e sicurezza.
---

## 🕐 L'orologio lampeggia?

Premete **brevemente 4 volte il tasto dell'orologio** finché l'icona non lampeggia, poi **ruotate la manopola** per impostare l'orario. Si blocca da solo dopo 10 s.

## 🍳 Cottura

Manopola sinistra = **funzione**, destra = **temperatura**.

- **Tradizionale** (resistenza alta + bassa) — pane, dolci, pizza
- **Ventola (convezione)** — **20-30 °C più bassa** della tradizionale
- **Grill** — doratura (max 250 °C)
...
Lavate vassoi e griglie, rimetteteli, poi fate andare **tradizionale 250 °C / 30 min** vuoto con una finestra aperta. Un leggero fumo o odore è normale — sono i rivestimenti protettivi che bruciano.
